...
constants/   questions.ts (genel kültür, 1163 soru: Tarih/Coğrafya/Vatandaşlık/Güncel), agsQuestions.ts (AGS/Eğitim Bilimleri, 751 soru: 9 alt dal), artworks.ts (81), facts.ts (101), topics.ts (31 ünite: 14 tarih + 10 coğrafya + 7 vatandaşlık), exams.ts, season.ts
